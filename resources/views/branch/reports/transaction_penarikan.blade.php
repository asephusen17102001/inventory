    ...
    <div class="row small-spacing justify-content-center">
        <div class="col-12">
            <div class="box-content bordered-all" style="padding: 2% !important;">
                <h4 class="box-title"><i class="fa fa-print"></i> Data Laporan Transaksi Penarikan By Branch {{ Auth::user()->branch->name }}</h4>
                ...
                <table class="table table-bordered dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid black !important;">
                                <a href="{{ route('branch.transactions.show', ['type' => 'penarikan', 'transaction' => $transaction]) }}" target="__blank">{{ $transaction->nomor_transaction }}</a>
                            </td>
                            <td style="border-top: 1px solid black !important;">
    ...
    $(document).ready(function() {
        ...
        $('.dataTable').dataTable({
            ...
            language: {
                ...
                info: "Total <b>_TOTAL_</b> Data <b>Transaksi Penarikan Branch {{ Auth::user()->branch->name }}</b> Tanggal : {{ date('d-m-Y', strtotime(request('f_tanggal_start'))) }} S/d. {{ date('d-m-Y', strtotime(request('f_tanggal_end'))) }}",
                infoEmpty: "Tidak ada data <b>Transaksi Penarikan Branch {{ Auth::user()->branch->name }}</b> tersedia",
            }
        });
    });

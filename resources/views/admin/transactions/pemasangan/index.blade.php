...
@section('title', 'Data Transaksi Pemasangan Product')
        ...
        <div class="col-10">
            <div class="box-content bordered" style="padding: 2% !important;">
                ...
                <div class="dropdown js__drop_down">
                    ...
                    <ul class="sub-menu">
                        <li><a href="{{ route('admin.transactions.create', ['type' => 'pemasangan']) }}">Add Data</a>
                        </li>
                ...
                <div class="row mb-3">
                    <div class="col-9"></div>
                    <div class="col-3">
                        <form action="{{ route('admin.transactions.index', ['type' => 'pemasangan']) }}" method="GET"
                            id="form-filter">
                    ...
                    <table class="table table-striped dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ route('admin.transactions.show', ['type' => 'pemasangan', 'transaction' => $transaction->id]) }}">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.transactions.show', ['type' => 'pemasangan', 'transaction' => $transaction->id]) }}"

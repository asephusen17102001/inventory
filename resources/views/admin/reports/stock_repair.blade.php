    ...
    <div class="row small-spacing justify-content-center">
        <div class="col-12">
            <div class="box-content bordered-all" style="padding: 2% !important;">
                <h4 class="box-title"><i class="fa fa-print"></i> Data Laporan Stock Repair / Recondition By Branch</h4>
                    ...
                    <table width="100%" cellpadding="10px" border="1px solid black">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @foreach ($stores as $store)
                                    @php
                                        $stock =  @$store->storeProducts->where('product_id', $product->id)->first()->stock_product_repair ?? 0;
                                        $sub_total += $stock;
                                        $total += $stock;
                                    @endphp
